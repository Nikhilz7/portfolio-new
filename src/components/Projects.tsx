...
const Projects = () => {
    ...
    <div id="projects" className="relative w-[600] h-full bg-gradient-to-br from-indigo-800 via-neutral-900 to-indigo-900 flex flex-row justify-center ">
        <div className="sm:max-w-[1700px] max-w-[900px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-start sm:ml-28">
            <h1 className="sm:text-6xl text-4xl font-display font-bold bg-neutral-200 bg-clip-text text-transparent sm:ml-[600px]">Projects</h1>
            
                {projects.map((project)=>(
              <div className="sm:items-center flex sm:flex-row flex-col p-2 m-6">
                  <div className="sm:w-full sm:min-h-[300px] bg-blend-lighten md:bg-blend-darken shadow-[0px_0px_30px_white] rounded-3xl   ">
                  
                        <img src={project.image} alt="" className=" sm:w-[1200px] sm:h-[400px] object-fill hover:translate-x-1 ease-out rounded-3xl sm:opacity-90 hover:opacity-100"/>
                    </div>  
